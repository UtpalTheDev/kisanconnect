...
import {
    loginUserPostLikeButtonPressed,loginUserPostDeleteButtonPressed
} from "./userSlice"
export default function UserPostComponent({eachpost}){
  ...
  const dispatch=useDispatch()
    return(
        ...
        <button
          ...
          onClick={() =>
            dispatch(
                loginUserPostLikeButtonPressed({ postID: eachpost._id, userName: userName })
            )
          }
        >
        ...
        {eachpost.user.userID === userId && (
          <button
            ...
            onClick={() => {
              dispatch(loginUserPostDeleteButtonPressed({ postdeleteobj: eachpost }));
            }}
          >
